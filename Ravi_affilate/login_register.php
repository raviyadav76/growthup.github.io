...
function updateReferral()
{
  ...
  if($result)
  {
    if(mysqli_num_rows($result)==1)
    {
      ...
      $point=$result_fetch['referral_point']+650;
...
if(isset($_POST['register']))
{
  ...
  if($result)
  {
    ...
    else #it will be executed if no one has taken username or email before
    {
      ...
      $query="INSERT INTO `registered_users`(`full_name`, `username`, `email`, `password`, `mobile`, `city`, `address`,`referral_code`,`referral_point`) 
      VALUES ('$_POST[fullname]','$_POST[username]','$_POST[email]','$password','$_POST[mobile]','$_POST[city]','$_POST[address]','$referral_code',0)";
